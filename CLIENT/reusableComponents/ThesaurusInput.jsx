...
function ThesaurusInputConstructor(apikey){
  return class ThesaurusInput extends React.Component {
    ...
    getSynonyms(word, wordIndex) {  
      ...
      axios.jsonp(`http://thesaurus.altervista.org/thesaurus/v1?word=${word}&language=en_US&output=json&key=${apikey}`,
        { timeout: 3500 })
        .then((result) => {
          this.setState((state) => {
